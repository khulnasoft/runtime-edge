...
Edge Runtime is built and maintained by the [Khulnasoft team](https://khulnasoft.io). For more details, read the [intro blog post](https://khulnasoft.com/blog/runtime-edge-self-hosted-deno-functions).
...
![Sequence diagram of Edge Runtime request flow](https://github.com/khulnasoft/runtime-edge/blob/main/runtime-edge-diagram.svg?raw=true)
...
```
docker build -t khulnasoft/runtime-edge .
docker run -it --rm -p 9000:9000 -v ./examples/:/examples khulnasoft/runtime-edge start --main-service /examples/main
```
...
To get started either open an issue on [GitHub](https://github.com/khulnasoft/runtime-edge/issues) or drop us a message on [Discord](https://discord.com/invite/R7bSpeBSJE)
